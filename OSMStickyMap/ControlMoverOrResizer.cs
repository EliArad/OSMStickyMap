...
namespace ControlManager
{
    public class ControlMoverOrResizer
    {
        ...
        static ResizeCallback pResizeCallback;
        public static void Init(Control control, ResizeCallback p)
        {
            pResizeCallback = p;
        ...
        public static void Stop(Control control)
        {
            ...
            control.MouseMove -= (sender, e) => StopDragOrResizing(control);
            ...
            if (_resizing)
            {
                if (MouseIsInLeftEdge)
                {
                    if (MouseIsInTopEdge)
                    {
                        ...
                        pResizeCallback(control, e.X, e.Y);
                    }
                    else if (MouseIsInBottomEdge)
                    {
                        control.Width -= (e.X - _cursorStartPoint.X);
